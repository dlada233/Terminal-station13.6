...
/obj/item/food/roast_dinner
	name = "大盘烤鸡"
	desc = "丰盛的烤鸡，配以卷心菜、防风草、土豆、豌豆、馅料和一碟肉酱."
	icon = 'icons/obj/food/meat.dmi'
...
/obj/item/food/roast_slice
	name = "小盘烤鸡"
	desc = "一小盘烤鸡、豌豆、卷心菜、防风草、土豆、填料和....等等，我就这些肉酱吗!"
	icon = 'icons/obj/food/meat.dmi'
...
/obj/item/food/roast_dinner_tofu
	name = "大盘烤鸡(伪)"
	desc = "丰盛的烤“鸡”，配以卷心菜、防风草、土豆、豌豆、馅料和一碟肉酱."
	icon = 'icons/obj/food/meat.dmi'
...
/obj/item/food/roast_slice_tofu
	name = "小盘烤鸡(伪)"
	desc = "一小盘“烤鸡”、豌豆、卷心菜、防风草、土豆、馅料....等等，我就这些肉酱吗!"
	icon = 'icons/obj/food/meat.dmi'
